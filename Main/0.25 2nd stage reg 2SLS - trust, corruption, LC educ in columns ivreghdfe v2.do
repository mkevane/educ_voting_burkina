...
* Education attainment affect trust in politicians, perception of corruption and living conditions

* Do file: 0.25 2nd stage reg 2SLS trust .do
* set directory - in 0.00
* Update; 24 august 2022 (ED)
...
* Compact table of second stage regression results	
	* option f in esttab makes it a fragment 
	...
	tab1 corrup_local_very  corrup_pres_very corrup_parl_very corrup_police_very trustin_local_very trustin_parl_very trustin_ceni_very trustin_pres_very salary_job roof_good	
	egen corrup_index=rowtotal(corrup_local_very  corrup_pres_very corrup_parl_very)
	egen trust_polit_index=rowtotal(trustin_local_very trustin_parl_very trustin_ceni_very trustin_pres_very )
	
	*local depvar "corrup_local_very  corrup_pres_very corrup_parl_very corrup_police_very trustin_local_very trustin_parl_very trustin_ceni_very trustin_pres_very salary_job roof_good	" 

	local depvar "corrup_index trust_polit_index salary_job roof_good	" 
	...
	*Year birth and commune
	...
	filefilter "$hd/reg_compact2SLS_`var'.tex" "$mkdropapp/Main_tab/Tab_stg2_mecb1_`var'_`gender'.tex", from("\BSaddlinespace") to(" ")	replace
	...
	*Year birth and commune
	...
	filefilter "$hd/reg_compact2SLS2_`var'.tex" "$mkdropapp/Main_tab/Tab_stg2_mecb2_`var'_`gender'.tex", from("\BSaddlinespace") to(" ")	replace
